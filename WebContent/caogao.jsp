...
<header class="header-navigation" id="header" style="color:#555555">
  <nav><div class="logo" ><a href="/" style="color:#555555;text-decoration: none;" >XX个人博客</a></div>
    ...
    <ul id="starlist" style="color:#555555">
      ...
      <li><a href="#">文章</a></li>
      <li><a href="#">留言</a></li>
      <li><a href="about.html" style="color:#0E6DAD">关于我</a></li>
      <li><a href="#">管理博客</a></li>
...
<div class="container" style="background-color:white;">
			...
			<div class="content">
				...
				<ul class="comment">
					...
					<li class="comli"><a class="a1" href="All.jsp" >已发表(0)</a></li>	
					<li class="comli"><a class="a1" href="simi.jsp" >私密(0)</a></li>
					<li class="comli"><a class="a1" href="caogao.jsp" id="comNow">草稿箱()</a></li>	
