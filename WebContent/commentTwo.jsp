	...
	<body>
		...
		<div class="container">
			...
			<div class="content">
				...
				<ul class="comment">
					<li class="comli"><a class="a" href="commentOne.html">我的文章评论</a></li>
					<li class="comli"><a class="a" href="#" id="comNow">我发表的评论</a></li>		
				</ul>
			<!--评论列表-->
				<ul class="commentList">
					<li class="commentLi">
						<div class="msgdiv">
							<!--评论头信息-->
							<span class="me">我</span>&nbsp;评论了
							<span class="username">小刚</span>&nbsp;的文章
							...
							<!--评论-->
							<div class="comdiv">
								aaaaaaaaaaaaaaaaaaaaaaaaaadddddddddddddddddddddddddddddddddddaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
							</div>
					...
					<li class="commentLi">
						<div class="msgdiv">
							<!--评论头信息-->
						<span class="me">我</span>&nbsp;评论了
							<span class="username">sdsddddddddddddddddddddddddda</span>&nbsp;的文章
							<a class="article" href="#">javanonon</a>
							<div class="do">
								<a class="delete" href="#">删除</a>
							</div>
							<!--评论-->
					...
					<li class="commentLi">
						<div class="msgdiv">
							<!--评论头信息-->
						<span class="me">我</span>&nbsp;评论了
							<span class="username">sdsdddda111</span>&nbsp;的文章
							<a class="article" href="#">javano----non</a>
							<div class="do">
								<a class="delete" href="#">删除</a>
							</div>
							<!--评论-->
